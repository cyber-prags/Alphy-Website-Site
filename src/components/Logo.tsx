...
const BRANDS: Record<string, Brand> = {
  ...
  google:                 { color: "#FFFFFF", bg: "#4285F4", domain: "google.com", short: "G" },
  googleworkspace:        { color: "#FFFFFF", bg: "#4285F4", domain: "google.com", short: "G" },
  googlecalendar:         { Icon: SiGooglecalendar, color: "#FFFFFF", bg: "#4285F4", domain: "calendar.google.com" },
  microsoft:              { color: "#FFFFFF", bg: "#0078D4", domain: "microsoft.com", short: "M" },
  microsoft365:           { color: "#FFFFFF", bg: "#0078D4", domain: "microsoft.com", short: "M" },
  outlook:                { color: "#FFFFFF", bg: "#0078D4", domain: "outlook.com", short: "O" },
  gong:                   { color: "#FFFFFF", bg: "#6C47FF", domain: "gong.io", short: "G" },
  clari:                  { color: "#FFFFFF", bg: "#1B1464", domain: "clari.com", short: "C" },
  linkedinsalesnavigator: { color: "#FFFFFF", bg: "#0A66C2", domain: "linkedin.com", short: "in" },
