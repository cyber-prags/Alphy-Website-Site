  ...
  return (
    <div className={`relative ${className}`}>
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(38,109,240,0.08) 0%, transparent 70%)",
        }}
      />
      <div
        className="relative rounded-[14px] overflow-hidden bg-white"
        style={{
      ...
      >
        ...
        >
          ...
          />
          <div className="ml-3 text-[10px] text-[rgba(15,18,24,0.45)] font-mono">
            sandbox.alphard.ai
          </div>
        </div>
...
function EmailCapture() {
  ...
  const handleSubmit = async () => {
    ...
    const endpoint = `${basePath}/api/collect-email`;
    ...
    try {
      ...
      posthog.capture("email_captured", { email, source: "landing_page" });
      setStatus("done");
    } catch {
      setStatus("error");
    }
  ...
  return (
    <div className="flex gap-2 max-w-lg mx-auto">
      <input
        ...
        style={{ border: "1px solid rgba(15,18,24,0.12)" }}
      />
      <button
        onClick={handleSubmit}
        disabled={status === "loading"}
        className="px-6 py-3 rounded-xl bg-[#266DF0] text-white text-sm font-semibold"
      >
        {status === "done" ? "✓ Got it" : "Get early access"}
      </button>
    </div>
  );
}
    ...
    >
      ...
      <div className="relative z-10 px-6 md:px-10 lg:px-12 max-w-[1320px] mx-auto">
        ...
        <section className="pt-20 md:pt-28 pb-14 md:pb-20 text-center">
          ...
          >
            Every signal in your book — usage, champion moves, ticket velocity,
            renewal proximity — fused into one ranked daily list of expansion
            plays. Built for Account Managers who treat their book like
          ...
          <Reveal delay={300} y={32}>
            <div className="mt-2 max-w-[1180px] mx-auto px-2 md:px-0">
              <ProductFrame
                ...
                alt="Alphard AM home — today's expansion plays"
              />
            </div>
          </Reveal>
        </section>
        ...
        <section className="py-20 md:py-28">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <Reveal>
              ...
              <h2
                className="text-[34px] md:text-[44px] font-semibold mb-5 leading-[1.05]"
                style={{ letterSpacing: "-0.03em" }}
              >
                Ask anything about your book.
                <br />
                <span style={{ color: "rgba(15,18,24,0.55)" }}>
                  Get the answer with the receipts.
                </span>
              </h2>
              <p
              ...
              >
                The Revenue Agent reads your CRM, calls, emails, calendar,
                product usage and ticket data — then answers in plain English
                with structured next steps. Every claim cites the underlying
                signal.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <Reveal delay={120} className="lg:order-2">
              ...
              <h2
                ...
                style={{ letterSpacing: "-0.03em" }}
              >
                Drafted emails that read like you — with the receipts already
                in.
              </h2>
              <p
                className="text-[15.5px] leading-relaxed mb-7"
                style={{ color: "rgba(15,18,24,0.62)" }}
              >
                Alphard reads your CRM, calls, calendar, product usage, and last
                week's emails — then drafts the follow-up with the right
                context, the right tone, the right next ask. You hit send.
              </p>
              <ul className="space-y-3 mb-2">
                {[
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <Reveal>
              ...
              <p
                ...
                style={{ color: "rgba(15,18,24,0.62)" }}
              >
                No more generic frameworks. Alphard reads the last 8 weeks of
                signals on each account and writes a tailored play-by-play — who
                to call, what to send, what to ask for. Updates the moment
        ...
        <section className="py-20 md:py-28">
          <Reveal>
            <div className="max-w-[820px] mx-auto text-center mb-14">
              ...
              <h2
                className="text-[34px] md:text-[48px] font-semibold mb-5 leading-[1.05]"
                style={{ letterSpacing: "-0.03em" }}
              >
                Health tools answer "will they churn?" Forecasts answer "will
                the deal close?"
                <br />
                <span style={{ color: "rgba(15,18,24,0.55)" }}>
                  Nobody answers the question that pays your number.
                </span>
              </h2>
              <p
                className="text-[16.5px] leading-relaxed max-w-[640px] mx-auto"
                style={{ color: "rgba(15,18,24,0.65)" }}
              >
                <span className="font-semibold" style={{ color: ACCENT }}>
                  "Which of my 40 accounts is ready to be 2x'd next quarter —
                  and what should I do about it on Tuesday?"
                </span>{" "}
                Alphard is built around that one question.
              </p>
            </div>
          </Reveal>
            ...
            {[
              {
                problem: "Gainsight",
                coded: "Health-coded",
                focus: "Tells you who's about to churn.",
              },
              {
                problem: "Clari",
                coded: "Forecast-coded",
                focus: "Tells you which deals will close.",
              },
              {
                problem: "Spreadsheets",
                coded: "Memory-coded",
                focus: "Tells you what you tracked manually.",
              },
            ].map((s) => (
              <div
                key={s.problem}
              ...
              >
                <div
                  className="text-[10.5px] font-semibold uppercase tracking-[0.14em] mb-1.5"
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <Reveal>
              ...
              <p
                ...
                style={{ color: "rgba(15,18,24,0.62)" }}
              >
                Usage spikes, champion moves, ticket velocity, renewal
                proximity, hiring signals — all aggregated into one expansion
                score per account. Re-ranked every morning. Built for the AM who
                opens their laptop at 8am and asks "what's heating up today?"
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <Reveal delay={120} className="lg:order-2">
              ...
              <h2
                ...
                style={{ letterSpacing: "-0.03em" }}
              >
                Where every account stands. Before quarterly planning forces the
                question.
              </h2>
              <p
                className="text-[15.5px] leading-relaxed mb-7"
                style={{ color: "rgba(15,18,24,0.62)" }}
              >
                Plot every customer on Health × Expansion potential. Decide
                where to push, where to defend, where to walk away — without
                spreadsheets, slide decks, or guesswork.
              </p>
            ...
            <Reveal className="lg:order-1">
              <ProductFrame
                ...
                alt="Portfolio quadrant — Boston-box for AMs"
              />
            </Reveal>
          </div>
        </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <Reveal>
              ...
              <h2
                ...
                style={{ letterSpacing: "-0.03em" }}
              >
                A four-quarter expansion plan per account. Not a 50-page slide
                deck.
              </h2>
              <p
                className="text-[15.5px] leading-relaxed mb-7"
                style={{ color: "rgba(15,18,24,0.62)" }}
              >
                Current ARR vs target. Quarterly bets ranked by stage.
                Stakeholder coverage matrix. Success criteria with green/red
                status. Everything you used to keep in a private spreadsheet —
                now living with the account.
              </p>
              <ul className="space-y-3.5">
                {[
            ...
            <Reveal delay={120}>
              <ProductFrame
                src="/screenshots/account-detail.png"
                alt="Growth plan per account"
              />
            </Reveal>
          </div>
        </section>
        ...
        <section className="py-20 md:py-24">
          <Reveal>
            <div className="text-center max-w-[640px] mx-auto mb-12">
              ...
              <h2
                className="text-[32px] md:text-[44px] font-semibold mb-3 leading-[1.05]"
                style={{ letterSpacing: "-0.03em" }}
              >
              ...
              {[
                {
                  ...
                  suffix: "x",
                  decimals: 1,
                  l: "Lift in expansion close rate",
                  c: ACCENT,
                },
                {
                  target: 112,
                ...
                },
                {
                  ...
                  suffix: " days",
                  decimals: 0,
                  l: "Cut from typical deal cycle",
                  c: "#0FC27B",
                },
              ].map((m, i) => (
                <div
                  key={i}
                  className="px-6 py-9 md:py-10 text-center bg-white"
                >
                  <div
                    className="text-[36px] md:text-[44px] font-semibold mb-1.5"
          ...
          <Reveal>
            <div className="text-center max-w-[640px] mx-auto mb-14">
              ...
              <p
                ...
                style={{ color: "rgba(15,18,24,0.65)" }}
              >
                Account briefs, pipeline forecasting, capacity planning, journey
                orchestration — all expansion-coded, all expensive elsewhere.
              </p>
            </div>
          </Reveal>
            ...
            {[
              {
                ...
                outcome: "$215K pipeline surfaced",
                copy: "Every customer with expansion score, hot signals, and pipeline coverage — at a glance.",
                src: "/screenshots/accounts.png",
                tone: ACCENT,
              },
              {
                title: "Account intelligence",
                outcome: "QBR prep cut to 8 minutes",
                copy: "Health, NRR, champion, success plan, and expansion bets in one continuously-updating view.",
                src: "/screenshots/account-detail.png",
                tone: "#7C3AED",
              },
              {
                title: "Forecast roll-up",
                outcome: "92% accuracy at week 8",
                copy: "Pipeline coverage, commit, most-likely, best case — by manager and by segment.",
                src: "/screenshots/forecast.png",
                tone: "#0FC27B",
              },
              {
                title: "Journey orchestration",
                outcome: "3.4× re-engagement lift",
                copy: "Adoption, onboarding, and expansion campaigns with conditional steps and live metrics.",
                src: "/screenshots/campaigns.png",
                tone: ACCENT,
              },
              {
                title: "Capacity planning",
                outcome: "Spot overload 2 weeks early",
                copy: "Workload heatmap across the team. Catch the at-risk book before churn shows up.",
                src: "/screenshots/capacity.png",
                tone: "#F5B900",
              },
              {
                title: "Revenue waterfall",
                outcome: "Stops $480K of leak",
                copy: "Funnel and ARR movement. Where revenue is born and where it leaks.",
              ...
              <Reveal key={f.title} delay={i * 60}>
                <div
                  className="group rounded-2xl overflow-hidden h-full bg-white transition-all hover:-translate-y-1 hover:shadow-[0_18px_50px_-18px_rgba(15,18,24,0.18)]"
                  style={{
                    border: "1px solid rgba(15,18,24,0.08)",
                ...
                >
                  <div
                    ...
                    style={{ borderColor: "rgba(15,18,24,0.06)" }}
                  >
                    <img
                      src={asset(f.src)}
                      alt={f.title}
                  ...
                  <div className="px-5 py-5">
                    <div className="text-[15.5px] font-semibold mb-1.5">
                      {f.title}
                    </div>
                    <div
        ...
        <section className="py-20 md:py-28">
          <Reveal>
            <div
              className="rounded-3xl px-8 py-14 md:px-16 md:py-20 max-w-[1100px] mx-auto"
              style={{
            ...
            >
              <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                <div>
                  ...
                  <h2
                    className="text-[30px] md:text-[40px] font-semibold mb-5 leading-[1.05]"
                  ...
                  >
                    Today, every AM walks out the door with their Excel, their
                    Slack DMs, their head full of context. Alphard makes the
                    institutional knowledge — champion intel, decision-maker
                    maps, comparable wins, pricing memory — a property of the
                ...
                <div className="relative">
                  <div
                    aria-hidden
                    className="absolute -inset-12 rounded-[40px] blur-3xl opacity-30 pointer-events-none"
                    style={{
                      background:
                        "radial-gradient(ellipse at center, rgba(38,109,240,0.5), transparent 70%)",
                    }}
                  />
                  <div
                  ...
                  >
                    ...
                    {[
                      {
                        label: "Champion intel",
                        value: "Maya Chen — VP Eng promoted Apr 26",
                        color: "#A4C2FA",
                      },
                      {
                        label: "Decision process",
                        value:
                          "Procurement: 3 quotes >$50K · Sec review required",
                        color: "#A4C2FA",
                      },
                      {
                        label: "Comparable wins",
                        value:
                          "Databricks $135K · HashiCorp $110K · Elastic $95K",
                        color: "#0FC27B",
                      },
                      {
                        label: "Pricing memory",
                        value:
                          "Last expansion at 18% discount, multi-year preferred",
                        color: "#FEBC2E",
                      },
                      {
                        label: "Owner history",
                        value: "Walid (current) ← Brad Allen (acquired 2024)",
                    ...
                    <div
                      className="text-[10.5px] text-center pt-2"
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <Reveal>
              ...
              <h2
                ...
                style={{ letterSpacing: "-0.03em" }}
              >
                Sell different products into different buyers — at the same
                customer.
              </h2>
              <p
                className="text-[15.5px] leading-relaxed mb-7"
                style={{ color: "rgba(15,18,24,0.62)" }}
              >
                Modern B2B SaaS sells Product A to RevOps, Product B to Sales,
                Product C to Engineering — same logo, different buyers,
                different motions. Alphard handles each product as its own
                expansion lane, with its own champion, its own comparable wins,
                its own playbook.
              </p>
              <ul className="space-y-3 mb-2">
                {[
        ...
        <section className="py-20 md:py-28">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              {
                Icon: Zap,
                title: "Expansion-first, retention-aware",
                copy: "Every score, every play, every ranking is expansion-coded — and CSMs get a clean view of health and adoption alongside. Both motions, one workspace.",
              },
              {
                Icon: Crown,
                title: "Champion intelligence built-in",
                copy: "Promotions, departures, role changes detected from email + calendar + LinkedIn — before they show up in your CRM.",
              },
              {
                Icon: TrendingUp,
                title: "Real outcomes, not frameworks",
                copy: "Models trained on real expansion conversions. Comparable-deal benchmarks per industry, segment, and product.",
              },
              {
                Icon: Users,
                title: "One workspace, four lenses",
                copy: "AE, AM, CSM, Manager — same data, different surfaces. No more stitching three SaaS tools together.",
              },
              {
                Icon: ShieldCheck,
                title: "Enterprise-grade by default",
                copy: "SOC 2, SSO, granular role-based access, full data residency. Yes, even in the demo.",
              },
              {
                Icon: LineChart,
        ...
        <section className="py-20 md:py-28 text-center">
          <Reveal>
            <h2
              className="text-[40px] md:text-[60px] font-semibold mb-5 leading-[1.02]"
            ...
            <p
              className="text-[16.5px] max-w-[560px] mx-auto mb-9"
              style={{ color: "rgba(15,18,24,0.62)" }}
            >
              The platform AMs switched to. Live sandbox spins up in under 30
              seconds.
            </p>
          ...
          <div className="flex flex-col md:flex-row justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span
                ...
                style={{ color: "rgba(15,18,24,0.45)" }}
              >
                © {new Date().getFullYear()} Alphard Analytics
              </span>
            </div>
            <div
              className="flex flex-wrap gap-x-7 gap-y-3 text-[13px]"
              style={{ color: "rgba(15,18,24,0.58)" }}
            >
              <a
  ...
  return (
    <div className="relative">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(38,109,240,0.10), transparent 70%)",
        }}
      />
      <div
        className="relative rounded-[14px] overflow-hidden bg-white"
        style={{
          ...
          boxShadow:
            "0 1px 2px rgba(15,18,24,0.04), 0 22px 70px -16px rgba(15,18,24,0.18)",
        }}
      >
        {/* Header row */}
        <div
        ...
        <div className="p-4">
                ...
                {acc.presence.map((has, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-center justify-center">
                      <div
                        className="w-9 h-9 rounded-lg grid place-items-center transition-all"
                        style={{
                          background: has ? p.color : "rgba(15,18,24,0.04)",
                          border: has
                            ? "none"
                            : "1px dashed rgba(15,18,24,0.15)",
                          boxShadow: has
                            ? `0 4px 12px -4px ${p.color}80`
                            : "none",
                        }}
                      >
                        {has ? (
                          ...
                          <Plus
                            size={11}
                            strokeWidth={2.2}
                            style={{ color: "rgba(15,18,24,0.30)" }}
                          />
                        )}
                      </div>
                    </div>
          ...
          >
            ...
            >
              ...
              <span className="inline-flex items-center gap-1.5">
                <span
                  className="w-2.5 h-2.5 rounded border border-dashed"
                  style={{ borderColor: "rgba(15,18,24,0.30)" }}
                />
                White space
              </span>
            </div>
  ...
  return (
    <section className="py-14 md:py-20">
      <div className="text-center mb-10">
        <p
          className="text-[11.5px] font-semibold uppercase tracking-[0.18em] mb-3"
          style={{ color: "rgba(15,18,24,0.45)" }}
        >
      ...
      <div
        className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-px rounded-2xl overflow-hidden"
        style={{
      ...
      >
        {INTEGRATIONS.map((i) => (
          ...
          >
            <div className="h-7 w-7 md:h-8 md:w-8 grid place-items-center">
              {i.logo}
            </div>
            <div
            ...
            <div
              ...
              style={{ color: "rgba(15,18,24,0.40)" }}
            >
              {i.group}
            </div>
          </div>
...
function SalesforceLogo() {
  return (
    <svg viewBox="0 0 32 32" className="w-full h-full" aria-hidden>
      <path
        d="M13.5 6c-1.5 0-2.8.6-3.7 1.6-1-1-2.4-1.6-3.9-1.6-3 0-5.5 2.4-5.5 5.4 0 .7.1 1.4.4 2-.4.7-.6 1.5-.6 2.4 0 2.8 2.3 5.1 5.1 5.1.5 0 1-.1 1.5-.2.9 1.6 2.7 2.7 4.7 2.7 1.7 0 3.2-.7 4.2-1.9.7.4 1.4.6 2.3.6 2.7 0 4.9-2.2 4.9-4.9 0-.5-.1-1-.2-1.5 1.1-.8 1.8-2.1 1.8-3.5 0-2.5-2-4.5-4.5-4.5-.5 0-1 .1-1.5.2C16.9 7 15.3 6 13.5 6z"
        fill="#00A1E0"
      />
    </svg>
  );
...
function LinkedInLogo() {
  return (
    <svg viewBox="0 0 32 32" className="w-full h-full" aria-hidden>
      ...
      <path
        d="M9 13v10h-3V13h3zm-1.5-4.5a1.7 1.7 0 1 1 0 3.4 1.7 1.7 0 0 1 0-3.4zM11 13h3v1.5c.5-.9 1.7-1.7 3.5-1.7 3.7 0 4.5 2.4 4.5 5.5V23h-3v-4.3c0-1.5-.4-2.7-2-2.7s-2 1.3-2 2.7V23h-3V13z"
        fill="white"
      />
    </svg>
  );
...
function GoogleLogo() {
  return (
    <svg viewBox="0 0 32 32" className="w-full h-full" aria-hidden>
      <path
        d="M28 16.3c0-.9-.1-1.7-.2-2.5H16v4.7h6.7c-.3 1.5-1.2 2.8-2.5 3.7v3.1h4c2.4-2.2 3.8-5.4 3.8-9z"
        fill="#4285F4"
      />
      <path
        d="M16 28c3.4 0 6.2-1.1 8.2-3l-4-3.1c-1.1.7-2.5 1.2-4.2 1.2-3.2 0-6-2.2-7-5.1H4.9v3.2C6.9 24.9 11.1 28 16 28z"
        fill="#34A853"
      />
      <path
        d="M9 17.9c-.2-.7-.4-1.5-.4-2.4s.1-1.6.4-2.4V9.9H4.9C4.1 11.5 3.6 13.4 3.6 15.5s.5 4 1.3 5.6L9 17.9z"
        fill="#FBBC05"
      />
      <path
        d="M16 8.7c1.8 0 3.4.6 4.7 1.8l3.5-3.5C22.2 4.9 19.4 3.5 16 3.5 11.1 3.5 6.9 6.6 4.9 11.1l4 3.2c1-2.9 3.8-5.6 7.1-5.6z"
        fill="#EA4335"
      />
    </svg>
  );
